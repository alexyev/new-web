    ...
    <div>
        ...
        <main className="flex w-full px-8 gap-8 mt-4">
            ...
            <section className="w-[75%]">
                <h1 className="text-4xl mb-4">Snapshots of my life...</h1>
                <div className="h-full">
                    <PhotoGrid
                        title="Princeton and New York"
                        photoPaths={["/photos/pny/1.jpg", "/photos/pny/2.jpg", "/photos/pny/3.jpg","/photos/pny/4.jpg","/photos/pny/5.jpg","/photos/pny/6.jpg","/photos/pny/7.jpg"]}
                    />
                    <PhotoGrid
                        title="Chicago"
                    ...
                    />
                    {/* <PhotoGrid
                        title="Lake Superior and Minnesota"
                        photoPaths={["/photos/ls/1.jpg", "/photos/ls/2.jpg", "/photos/ls/3.jpg", "/photos/ls/4.jpg", "/photos/ls/5.jpg", "/photos/ls/6.jpg", "/photos/ls/7.jpg", "/photos/ls/8.jpg", "/photos/ls/10.jpg"]}
                    /> */}
                </div>
            </section>
        </main>
